...
Local $index = Number(StringTrimLeft(@Username, 2)) - 1
Local $ending = $usernames[$index]
Local $file_name = @UserName & $ending
...
ControlSetText("Add FlashBack Movies", "", "Edit1", $file_name & ".fbr")
Send("!O")
;WinWaitActive("Add FlashBack Movies")
